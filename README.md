...
* Engine size, horsepower, and performance metrics
* Car dimensions and weight
* Fuel type and mileage
* Body style and brand
* Market price (target variable)

Each row represents a unique car model with its corresponding attributes.
...
2. **Exploratory Data Analysis (EDA)**
   ...
   * Visualized key patterns affecting pricing
